        ...
        { (formik) =>{
          ...
          return (
            <Form className="form">
              ...
              <div className="row mt-3" >
                <button type="button" className="ml-3 btn btn-primary" style={{width:"150px"}} onClick={()=> formik.setFieldTouched('bio')}>Visited Bio</button>
                <button type="button" className="ml-3 btn btn-primary" style={{width:"150px"}} onClick={()=> formik.setTouched()}>Visited All</button>

                <button type="button" className="ml-3 btn btn-primary" style={{width:"150px"}} onClick={()=> formik.validateField('bio')}>Validate Address</button>
                <button type="button" className="ml-3 btn btn-primary" style={{width:"150px"}} onClick={()=> formik.validateForm()}>Validate All</button>
                <button type="submit" className="ml-3 btn btn-primary" style={{width:"150px"}}>Submit Form</button>
              </div>
            </Form>
          )
        }}
